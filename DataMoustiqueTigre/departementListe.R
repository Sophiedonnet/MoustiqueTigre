departement_lookup <- data.frame(
  code_departement = c( "1", "2", "3", "4", "5", "6", "7", "8", "9",
  ...
  name_departement = c( "Ain", "Aisne", "Allier", "Alpes-de-Haute-Provence", "Hautes-Alpes", "Alpes-Maritimes", "Ardèche", "Ardennes", "Ariège",
    ...
    "Mayotte", "Saint-Barthélemy", "Saint-Martin", "Terres australes et antarctiques françaises", "Wallis-et-Futuna", "Polynésie française", "Nouvelle-Calédonie"
  ),
